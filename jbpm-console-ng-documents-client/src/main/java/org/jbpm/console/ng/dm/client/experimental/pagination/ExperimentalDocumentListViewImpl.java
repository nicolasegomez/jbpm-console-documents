...
@Dependent
@Templated(value = "ExperimentalDocumentListViewImpl.html")
public class ExperimentalDocumentListViewImpl extends BaseViewImpl<DataMockSummary, ExperimentalDocumentListPresenter>
        implements ExperimentalDocumentListPresenter.BasicPaginationListView {
    ...
    private org.jbpm.console.ng.gc.client.resources.GenericImages images = GWT.create(GenericImages.class);

    @Override
    public void init(final ExperimentalDocumentListPresenter presenter) {
